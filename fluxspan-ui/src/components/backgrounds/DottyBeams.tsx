    ...
    >
      <div className="absolute inset-0">
        <div
          ...
          style={{
            background: `radial-gradient(100% 100% at 0% 0%, ${color2} 0%, ${color3} 100%)`,
            mask: `radial-gradient(125% 100% at 0% 0%, ${color3} 0%,
        ...
        >
          ...
          <div
            ...
            style={{
              background: `linear-gradient(${color1} 0%, ${withOpacity(color1, 0)} 100%)`,
              mask: `linear-gradient(90deg, ${withOpacity(color3, 0)} 0%, ${color3} 20%,
          ...
          <div
            ...
            style={{
              background: `linear-gradient(${color1} 0%, ${withOpacity(color1, 0)} 100%)`,
              mask: `linear-gradient(90deg, ${withOpacity(color3, 0)} 11%, ${color3} 25%,
          ...
          <div
            ...
            style={{
              background: `linear-gradient(${color1} 0%, ${withOpacity(color1, 0)} 100%)`,
              mask: `linear-gradient(90deg, ${withOpacity(color3, 0)} 9%, ${color3} 20%,
                   ${withOpacity(color3, 0.55)} 28%, ${withOpacity(color3, 0.424)} 40%,
                   ${color3} 48%, ${withOpacity(color3, 0.267)} 54%,
          ...
          <div
            ...
            style={{
              background: `linear-gradient(${color1} 0%, ${withOpacity(color1, 0)} 100%)`,
              mask: `linear-gradient(90deg, ${withOpacity(color3, 0)} 0%, ${color3} 17%,
                   ${withOpacity(color3, 0.55)} 26%, ${color3} 35%, ${withOpacity(color3, 0)}
          ...
          <div
            ...
            style={{
              background: `linear-gradient(${color1} 0%, ${withOpacity(color1, 0)} 100%)`,
              mask: `linear-gradient(90deg, ${withOpacity(color3, 0)} 0%, ${color3} 20%,
                   ${withOpacity(color3, 0.55)} 27%, ${color3} 42%, ${withOpacity(color3, 0)}
      ...
      <div className="bg-gradient-radial absolute inset-0 from-slate-800/20 via-transparent to-transparent" />
