...
export function AuthForm({className}: AuthFormProps) {
  return (
    <div className={cn("w-full h-[calc(100dvh-10rem)] flex flex-col justify-center items-center", className)}>
      <form className="w-screen max-w-2xl h-screen flex flex-col items-center gap-8 p-12 bg-rose-100">
